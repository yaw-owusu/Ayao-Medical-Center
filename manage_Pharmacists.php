    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-person-check"></i><span>Administrator</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-person-gear"></i><span>General Services</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
                  ...
                  <div class="container">
                    <form class="row g-3 mt-3">
                      <div class="col-md-8 offset-md-2">
                        <div class="col-12">
                          <label for="home_inputName" class="form-label">Name</label>
                          <input type="text" class="form-control" id="home_inputName" />
                        </div>
                        <div class="col-12">
                          <label for="home_inputEmail" class="form-label">Email</label>
                          <input type="email" class="form-control" id="home_inputEmail" />
                        </div>
                        <div class="col-12">
                          <label for="home_inputPhoneNumber" class="form-label">Phone Number</label>
                          <input type="password" class="form-control" id="home_inputPhoneNumber" />
                        </div>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  <div class="container">
                    <form class="row g-3 mt-3">
                      <div class="col-md-8 offset-md-2">
                        <div class="col-12">
                          <label for="profile_inputName" class="form-label">Name</label>
                          <input type="text" class="form-control" id="profile_inputName" />
                        </div>
                        <div class="col-12">
                          <label for="profile_inputEmail" class="form-label">Email</label>
                          <input type="email" class="form-control" id="profile_inputEmail" />
                        </div>
                        <div class="col-12">
                          <label for="profile_inputPhoneNumber" class="form-label">Phone Number</label>
                          <input type="password" class="form-control" id="profile_inputPhoneNumber" />
                        </div>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                  <div class="container">
                    <form class="row g-3 mt-3" action="">
                      <div class="col-md-8 offset-md-2">
                        <label for="contact_pharmacistId">Select the pharmacist to delete</label>
                        <select class="form-select my-2" name="vehicleId" id="contact_pharmacistId">
                            ...
                            <tbody>
                              <?php foreach (get_all_pharmacists() as $pharmacist) : ?>
                                <tr>
                                  ...
                                  <td><?php echo $pharmacist['availability'] ?></td>
                                </tr>
                              <?php endforeach; ?>
                            </tbody>
                          </table>
