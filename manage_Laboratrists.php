                  ...
                  <div class="container">
                    <form class="row g-3 mt-3">
                      <div class="col-md-8 offset-md-2">
                        <div class="col-12">
                          <label for="inputNanme4" class="form-label">Laboratrists Name</label>
                        ...
                        <div class="col-12">
                          ...
                          <input type="text" class="form-control" id="inputAddress" placeholder="2022" />
                        </div>
                        <div class="col-12 mb-4">
                          <label for="inputAddress" class="form-label">Price</label>
                          <input type="text" class="form-control" id="inputAddress" placeholder="$3000" />
                        </div>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                  <div class="container">
                    <form class="row g-3 mt-3" action="">
                      <div class="col-md-8 offset-md-2">
                        <label for="vehicleId">Select the Laboratrists to delete</label>
                        <select class="form-select my-2" name="vehicleId" id="vehicleId">
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <h5 class="card-title">All Laboratory Technicians</h5>
                          <table class="table table-borderless datatable">
                            ...
                            <tbody>
                              <?php foreach(get_all_laboratrists() as $labTech): ?>
                                <tr>
                                  <td><?php echo $labTech['name']; ?></td>
                                  <td><?php echo $labTech['email']; ?></td>
                                  <td><?php echo $labTech['phone_numbers']; ?></td>
                                  <td><?php echo $labTech['availability']; ?></td>
                                </tr>
                              <?php endforeach; ?>
                            </tbody>
                          </table>
