                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                  <div class="container">
                    <form class="row g-3 mt-3" action="">
                      <div class="col-md-8 offset-md-2">
                        <label for="vehicleId">Select The Testimonial To Delete</label>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <h5 class="card-title">All Accountants</h5>
                          <table class="table table-borderless datatable">
                            ...
                            <tbody>
                              <?php foreach(get_all_accountants() as $accountant): ?>
                                <tr>
                                  <td><?php echo $accountant['name']; ?></td>
                                  <td><?php echo $accountant['email']; ?></td>
                                  <td><?php echo $accountant['phone_numbers']; ?></td>
                                  <td><?php echo $accountant['availability']; ?></td>
                                </tr>
                              <?php endforeach; ?>
                            </tbody>
                          </table>
