                  ...
                  <div class="container">
                    <form class="row g-3 mt-3">
                      <div class="col-md-8 offset-md-2">
                        <div class="col-12">
                          <label for="inputNanme4" class="form-label">Brand ID</label>
                  ...
                  <div class="container">
                    <form class="row g-3 mt-3">
                      <div class="col-md-8 offset-md-2">
                        ...
                        <div class="col-12">
                          <label for="inputNanme4" class="form-label">Date Updated</label>
                          <input type="Date" class="form-control" id="inputNanme4" />
                        </div>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                  <div class="container">
                    <form class="row g-3 mt-3" action="">
                      <div class="col-md-8 offset-md-2">
                        <label for="vehicleId">Select The Brand To Delete</label>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <h5 class="card-title">All Nurses</h5>
                          <table class="table table-borderless datatable">
                            ...
                            <tbody>
                              <?php foreach (get_all_nurses() as $nurse) : ?>
                                <tr>
